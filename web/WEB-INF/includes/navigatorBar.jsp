	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="#" data-toggle="modal" data-target="#loginForm"><b>Đăng nhập</b></a></li>
				<li><a href="#" data-toggle="modal" data-target="#signUpForm"><b>Đăng kí</b></a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<img alt="" src="<%=request.getContextPath()%>/images/0.jpg" class="img-rounded" alt="Ảnh đại diện của ${requestScope.user.fullname}" width="45" height="45"><b> Ngô Văn Thiện</b>
				</li>
				<li>
