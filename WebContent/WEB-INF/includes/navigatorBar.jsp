...
<!-- BEGIN HEADER -->
<div class="header navbar navbar-fixed-top" style="background-color:#2E2E2E;">
	...
	<div class="header-inner">
		...
		<ul class="nav navbar-nav">
				...
				<li><input type="text" class="form-control" placeholder="Text input"></li>
...
<div class="row" style="background-color: black;height: 50px;width: 1800px"></div>
</div>
<!-- END HEADER -->
<div class="row" style="background-color: black;height: 50px;width: 1800px"></div>