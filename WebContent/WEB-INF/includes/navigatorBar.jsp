<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/${initParam['hostname']}"> <img alt="Student Work"
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="#" data-toggle="modal" data-target="#loginForm">Đăng
						nhập</a></li>
				<li><a href="#" data-toggle="modal" data-target="#signUpForm">Đăng
						ký</a></li>
