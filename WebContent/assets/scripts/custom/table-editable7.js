var TableEditable7 = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var oTable = $('#sample_editable_7').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, -1],
            ...
            $('#sample_editable_7_new').click(function (e) {
                e.preventDefault();
            ...
            $('#sample_editable_7 a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#sample_editable_7 a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#sample_editable_7 a.edit').live('click', function (e) {
                e.preventDefault();
